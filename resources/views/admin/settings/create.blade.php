    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('short_descrption') ? 'is-invalid' : '' }}" name="short_descrption" id="short_descrption">{!! old('short_descrption') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('donation_url') ? 'is-invalid' : '' }}" type="text" name="donation_url" id="donation_url" value="{{ old('donation_url', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('chairman_description') ? 'is-invalid' : '' }}" type="text" name="chairman_description" id="chairman_description" value="{{ old('chairman_description', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_1_text') ? 'is-invalid' : '' }}" type="text" name="counter_1_text" id="counter_1_text" value="{{ old('counter_1_text', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_1_value') ? 'is-invalid' : '' }}" type="number" name="counter_1_value" id="counter_1_value" value="{{ old('counter_1_value', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_2_text') ? 'is-invalid' : '' }}" type="text" name="counter_2_text" id="counter_2_text" value="{{ old('counter_2_text', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_2_value') ? 'is-invalid' : '' }}" type="number" name="counter_2_value" id="counter_2_value" value="{{ old('counter_2_value', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_3_text') ? 'is-invalid' : '' }}" type="text" name="counter_3_text" id="counter_3_text" value="{{ old('counter_3_text', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_3_value') ? 'is-invalid' : '' }}" type="number" name="counter_3_value" id="counter_3_value" value="{{ old('counter_3_value', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_4_text') ? 'is-invalid' : '' }}" type="text" name="counter_4_text" id="counter_4_text" value="{{ old('counter_4_text', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('counter_4_value') ? 'is-invalid' : '' }}" type="number" name="counter_4_value" id="counter_4_value" value="{{ old('counter_4_value', '') }}" step="1">
            ...
            <div class="form-group">
                <label class="required" for="home_card_1_text">{{ trans('cruds.setting.fields.home_card_1_text') }}</label>
                <textarea class="form-control {{ $errors->has('home_card_1_text') ? 'is-invalid' : '' }}" name="home_card_1_text" id="home_card_1_text" required>{{ old('home_card_1_text') }}</textarea>
                @if($errors->has('home_card_1_text'))
                    <div class="invalid-feedback">
                        {{ $errors->first('home_card_1_text') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.setting.fields.home_card_1_text_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="home_card_2_text">{{ trans('cruds.setting.fields.home_card_2_text') }}</label>
                <textarea class="form-control {{ $errors->has('home_card_2_text') ? 'is-invalid' : '' }}" name="home_card_2_text" id="home_card_2_text" required>{{ old('home_card_2_text') }}</textarea>
                @if($errors->has('home_card_2_text'))
                    <div class="invalid-feedback">
                        {{ $errors->first('home_card_2_text') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.setting.fields.home_card_2_text_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="home_card_3_text">{{ trans('cruds.setting.fields.home_card_3_text') }}</label>
                <textarea class="form-control {{ $errors->has('home_card_3_text') ? 'is-invalid' : '' }}" name="home_card_3_text" id="home_card_3_text" required>{{ old('home_card_3_text') }}</textarea>
                @if($errors->has('home_card_3_text'))
                    <div class="invalid-feedback">
                        {{ $errors->first('home_card_3_text') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.setting.fields.home_card_3_text_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="work_time">{{ trans('cruds.setting.fields.work_time') }}</label>
                <input class="form-control {{ $errors->has('work_time') ? 'is-invalid' : '' }}" type="text" name="work_time" id="work_time" value="{{ old('work_time', '') }}" required>
                @if($errors->has('work_time'))
                    <div class="invalid-feedback">
                        {{ $errors->first('work_time') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.setting.fields.work_time_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('values') ? 'is-invalid' : '' }}" name="values" id="values">{!! old('values') !!}</textarea>
